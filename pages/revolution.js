...
export default function Revolution(props) {
	...
	const sections = [
		{
			...
			title: "Consultation",
			paragraphs: [
				`The Web process begins the moment you realize you need a piece of technology for your business. Whether you already have an idea for
		...
		},
		{
			...
			title: "Review",
			paragraphs: [
				`Before moving any farther,  i come back to you with a progress report. This gives you the freedom to discuss any changes you may want or any ideas you may have come up with before any heavy lifting has been done.`,
				`I give you an interactive demonstration of the mockups, thoroughly explaining the thought process that went into each screen and every anticipated feature.`,
		...
		},
		{
			...
			paragraphs: [
				...
				`Engineering begins after your approval on the final designs. I start by scaffolding out the project on a high level, prioritizing some areas over others.', 'Each area is then developed in order of importance until ready to be connected to the next piece.`,
				`Typically the backend, behind the scenes operations are completed first. Once all the services are in place, i  can then create the front end (smiles), user side of things.`,
				`Finishing the application doesn’t mean i'm done though, because i also utilize extensive testing to guarantee compatibility with all intended devices.`,
				`Only after our rigorous examinations will i accept a product as finished, then pushing it through the production pipeline. This produces an optimized, compressed, consumer version of the code and assets ready for deployment.`,
			],
		},
		{
			icon: "/assets/jet.svg",
			...
			paragraphs: [
				...
				`When construction comes to a close you’re the first one to know. We’ll give our final demonstration to show off your shiny new website application/ software in the wild so you know exactly how it will look to your users.`,
	...
	return (
		<Grid direction="column">
			<Head>
				<title key="title">
					The Revolution - Cutting-edge Websites built with React, Node | Amaben
					Technologies
				</title>
				<meta
					name="description"
					key="description"
					content="Visionary insights, coupled with ground-breaking technology is a catalyst for revolution. Contact us for your website needs."
				/>
				h1
				<meta
					property="og:title"
					content="Bringing the Powerful React Technology to You | Web Revolution"
				/>
				<meta
					property="og:url"
					key="og:url"
					content="https://amabentechnologies.ng/revolution"
				/>
				<link
					rel="canonical"
					key="canonical"
					href="https://amabentechnologies.ng/revolution"
				/>
			</Head>
			...
			>
				<Grid item lg>
					<img
						style={{
							maxWidth: matchesXS ? 200 : matchesSM ? 300 : "30em",
							width: matchesXS ? 700 : undefined,
							marginLeft: matchesXS ? -59 : undefined,
				...
				>
					...
					<Grid item>
						...
						<Typography
							...
							gutterBottom
						>
							I want to help businesses capitalize on the latest and greatest
							technology. The best way to predict the future is to be the one
							building it, and i want to help guide the world into this next
						...
						<Typography
							...
							gutterBottom
						>
							By holding ourselves to rigorous standards and pristine quality, i
						...
						<Typography
							...
							gutterBottom
						>
							I see a future where every individual has personalized software
			...
			>
				...
				<Grid
					item
					style={{ marginRight: matchesXS ? "4em" : undefined }}
					lg
