...
function WebsiteDevelopment(props) {
	...
	return (
		<Grid container direction="column">
			<Head>
				<title key="title">
					I Build Stunning Custom Website Solutions for Businesses | Amaben
					Technologies
				</title>
				<meta
					name="description"
					key="description"
					content="Excellently built websites from scratch to be lightweight, efficient, optimized for all screens and devices. Optimized code, server side rendering, and perfect responsive design | 99% PageSpeed score | Seo optimized"
				/>
				<meta
					property="og:title"
					content="Bringing the Powerful React Technology to You | Website Development"
				/>
				<meta
					property="og:url"
					key="og:url"
					content="https://amabentechnologies.ng/websitedevelopment"
				/>
				<link
					rel="canonical"
					key="canonical"
					href="https://amabentechnologies.ng/websitedevelopment"
				/>
			</Head>
			<Grid
				item
			...
			>
				...
				<Grid item container direction="column" className={classes.heading}>
					...
					<Grid item>
						...
						>
							...
							yourself, i can build cross-platform native solutions for any part
							of your business process. This opens you up to a whole new world
							of possibilities by taking advantage of phone features like the
				...
				<Hidden mdDown>
					<Grid item className={classes.arrowContainer}>
						...
						>
							<img src="../assets/forwardArrow.svg" alt="Training" />
						</IconButton>
					</Grid>
				</Hidden>
			</Grid>
			...
			<Grid item style={{ marginTop: 0 }}>
				...
				>
					<Card className={matchesXS ? null : classes.revolutionCard}>
						<CardContent>
							<Grid
								container
								direction="column"
					...
					<div className={matchesXS ? null : classes.revolutionBackground} />
				</Grid>
			</Grid>
			<Grid
				style={{ marginTop: matchesXS ? "1em" : "5em", marginBottom: "5em" }}
				item
				container
				direction={matchesSM ? "column" : "row"}
				justify="flex-end"
			...
			>
				...
				>
					...
					>
						{" "}
						Customers don’t go there either, so i make sure your website is
